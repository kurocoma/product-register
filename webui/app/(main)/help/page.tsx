    ...
    <div className="p-6 space-y-4 max-w-3xl">
      ...
      <HelpSection id="screen-products" title="📦 商品一覧">
        ...
        <ol className="list-decimal list-inside space-y-1">
          ...
          <li>
            上部の「モール既存商品を取込んで編集」では、商品管理番号（商品コード）の入力に加えて「🔍 商品名で検索」から
            候補を選んで取込める（Yahoo の商品名検索は公開中の商品のみが対象）。候補にチェックを付けて
            「まとめて取込」を押すと複数商品を一括で取込める（1件ずつ順番に取込み、行ごとに 新規/既存/失敗 を表示）
          </li>
        </ol>
